        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="quantity" required min="1" 
                       value="<?php if (isset($_POST['quantity'])) echo htmlspecialchars($_POST['quantity']); ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Price per Item</label>
                <input type="number" class="form-control" name="price" required min="1" 
                       value="<?php if (isset($_POST['price'])) echo htmlspecialchars($_POST['price']); ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="addons[]" value="Gift Wrap"
                        <?php if (isset($_POST['addons']) && in_array('Gift Wrap', $_POST['addons'])) echo 'checked'; ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="addons[]" value="Express Shipping"
                        <?php if (isset($_POST['addons']) && in_array('Express Shipping', $_POST['addons'])) echo 'checked'; ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="addons[]" value="Warranty"
                        <?php if (isset($_POST['addons']) && in_array('Warranty', $_POST['addons'])) echo 'checked'; ?>>
